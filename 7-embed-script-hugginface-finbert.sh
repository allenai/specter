...
python scripts/embed.py \
--ids thesis_data/embedding_test_data/sample.ids \
--metadata thesis_data/embedding_test_data/sample-metadata.json \
--model ./hf_model/finnish_bert.tar.gz \
--output-file output_hf_finnish_data_demo.jsonl \
--vocab-dir data/finbert_vocab/ \
--batch-size 16 \
--cuda-device -1 \
# 0 = use GPU, -1 = use CPU
