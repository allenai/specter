...
*NOTE*: Embeddings that are retrieved from the public API would not exactly match embeddings that can be generated by running the model on this repo.
However, the performance on downstream tasks are similar.
