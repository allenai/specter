...
"""
以下は基本的にallennlp用に加工されたデータを読み取ったり、Transformers用に変換、トークナイズするためのコード
"""
...
"""
ここまで（「以下は基本的にallennlp用に加工されたデータを読み取ったり、Transformers用に変換、トークナイズするためのコード」がここまで）
"""
